...
function Navbar() {
    ...
    return (
        ...
        >
            ...
            <div id="humbergerButton" className="humberger cursor-pointer lg:hidden" onClick={toggleMenu}>
            ...
            <div className="action language lg:flex hidden justify-center gap-5 items-center">
                ...
                <a href="https://firmansyah-dev.tech/admin/login" className="text-xs ">Log in</a>
                <a href="https://firmansyah-dev.tech/admin/register" className="text-xs  bg-white text-black py-2 px-4 rounded-full">Sign up</a>
            </div>
            <div
                id="mobileNav"
            ...
            >
                <ul className="inline-flex flex-col items-start gap-5">
                    ...
                    <li className="flex items-center justify-between gap-4">
                        <a href="https://firmansyah-dev.tech/admin/login" className="text-xs ">Log in</a>
                        <a href="https://firmansyah-dev.tech/admin/register" className="text-xs text-black">Sign up</a>
                    </li>
                </ul>
            </div>
        </div>
